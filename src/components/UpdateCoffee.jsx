...
const UpdateCoffee = () => {
    ...
    return (
        <div className='lg:w-3/4 mx-auto'>
            <div className="text-center p-10">
                <h1 className="text-5xl font-bold update-coffee-title" >
            ...
            <div className="card bg-base-100 w-full shadow-2xl p-8">
                <form onSubmit={handleUpdateCoffee} className="card-body">
                    ...
                    <div className="form-control mt-6">
                        <button className="btn bg-[#D2B48C] text-black border border-black hover:bg-[#c8a780]">
